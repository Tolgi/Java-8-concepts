...
final class IntegerArray{
    ...
    IntegerArray(int[] array) {
        this.array = Arrays.copyOf(array, array.length);    // immutable class rule, must make deep copy of elements
    }
    ...
    public IntegerArray concat(IntegerArray ia){
        int [] result = new int[ia.array.length + this.array.length];
        System.arraycopy(this.array, 0, result, 0, this.array.length);
        System.arraycopy(ia.array, 0, result, this.array.length, ia.array.length);
