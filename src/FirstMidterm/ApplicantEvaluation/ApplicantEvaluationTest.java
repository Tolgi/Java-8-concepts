package FirstMidterm.ApplicantEvaluation;
...
class EvaluatorBuilder {
    public static Evaluator build(Evaluator.TYPE type) throws InvalidEvaluation {
        ...
        switch (type){
            ...
            case MORE_EXPERIENCE_AND_MORE_CREDIT_SCORE: return applicant -> applicant.getEmploymentYears() > 10 && (applicant.getCreditScore() >= 500);
