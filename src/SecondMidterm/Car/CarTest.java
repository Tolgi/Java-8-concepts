...
class Car {
    ...
    private int price;
    private int power;
    public static Comparator<Car> carComparator = Comparator.comparingInt(Car::getPrice)
...
class CarCollection {
    ...
    public void sortByPrice(boolean ascending) {
        ...
        if(ascending) comparator = Car.carComparator;
        else comparator = Car.carComparator.reversed();
