...
class Audition{
    private Map<String, Set<Particpant>> particpants;
    ...
    public void addParticpant(String city, String code, String name, int age) {
        ...
        particpants.putIfAbsent(city, new HashSet<>());

        particpants.get(city).add(particpant);
    }

    public void listByCity(String city) {
        particpants.getOrDefault(city, new HashSet<>())
                .stream()
