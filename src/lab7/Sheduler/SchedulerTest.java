...
//       return scheduler.get(key);
    ...
    public ArrayList<T> getAll(Date begin, Date end) {
       return new ArrayList<>(scheduler.subMap(begin, false, end, false).values());
    }

    public T getFirst() {
        return scheduler.get(scheduler.firstKey());
    }

    public T getLast() {
        return scheduler.get(scheduler.lastKey());
    }
}
